...
export class PostDataComplianceDeletionEventsSecurity extends SpeakeasyBase {
...
export class PostDataComplianceDeletionEventsErrorResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: PostDataComplianceDeletionEventsErrorResponseDetails })
  @Expose({ name: "details" })
...
export class PostDataComplianceDeletionEventsResponse extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  postDataComplianceDeletionEvents202ApplicationJSONObject?: Record<string, any>;
}