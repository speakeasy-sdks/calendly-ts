...
export class PostOrganizationsUuidInvitationsSecurity extends SpeakeasyBase {
...
export class PostOrganizationsUuidInvitationsErrorResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: PostOrganizationsUuidInvitationsErrorResponseDetails })
  @Expose({ name: "details" })
