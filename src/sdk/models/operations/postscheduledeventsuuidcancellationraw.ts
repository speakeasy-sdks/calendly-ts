...
export class PostScheduledEventsUuidCancellationSecurity extends SpeakeasyBase {
...
export class PostScheduledEventsUuidCancellationRawErrorResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: PostScheduledEventsUuidCancellationRawErrorResponseDetails })
  @Expose({ name: "details" })
