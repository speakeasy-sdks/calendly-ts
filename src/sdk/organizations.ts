...
export class Organizations {
  ...
  **/
  deleteOrganizationsUuidMemberships(
    ...
    const url: string = utils.generateURL(baseURL, "/organization_memberships/{uuid}", req.pathParams);
  ...
  **/
  getOrganizationMemberships(
    ...
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/organization_memberships";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.getOrganizationMemberships200ApplicationJSONObject = utils.deserializeJSONResponse(
                httpRes?.data,
  ...
  **/
  getOrganizationsOrgUuidInvitationsUuid(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/organizations/{org_uuid}/invitations/{uuid}", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.getOrganizationsOrgUuidInvitationsUuid200ApplicationJSONObject = utils.deserializeJSONResponse(
                httpRes?.data,
  ...
  **/
  getOrganizationsUuidInvitations(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/organizations/{uuid}/invitations", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.getOrganizationsUuidInvitations200ApplicationJSONObject = utils.deserializeJSONResponse(
                httpRes?.data,
  ...
  getOrganizationsUuidMemberships(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.getOrganizationsUuidMemberships200ApplicationJSONObject = utils.deserializeJSONResponse(
                httpRes?.data,
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 201:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.postOrganizationsUuidInvitations201ApplicationJSONObject = utils.deserializeJSONResponse(
                httpRes?.data,
          ...
          case httpRes?.status == 403:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.postOrganizationsUuidInvitations403ApplicationJSONObject = utils.deserializeJSONResponse(
                httpRes?.data,
  ...
  revokeUsersOrganizationInvitation(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          ...
          case httpRes?.status == 403:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.revokeUsersOrganizationInvitation403ApplicationJSONObject = utils.deserializeJSONResponse(
                httpRes?.data,
