...
export class Availability {
  ...
  **/
  getUserAvailabilitySchedules(
    ...
    const url: string = baseURL.replace(/\/$/, "") + "/user_availability_schedules";
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.getUserAvailabilitySchedules200ApplicationJSONObject = utils.deserializeJSONResponse(
                httpRes?.data,
          ...
          case httpRes?.status == 403:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.getUserAvailabilitySchedules403ApplicationJSONObject = utils.deserializeJSONResponse(
                httpRes?.data,
  ...
  **/
  getUserAvailabilitySchedulesUuid(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/user_availability_schedules/{uuid}", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.getUserAvailabilitySchedulesUuid200ApplicationJSONObject = utils.deserializeJSONResponse(
                httpRes?.data,
          ...
          case httpRes?.status == 403:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.getUserAvailabilitySchedulesUuid403ApplicationJSONObject = utils.deserializeJSONResponse(
                httpRes?.data,
  ...
  getUserBusyTimes(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.getUserBusyTimes200ApplicationJSONObject = utils.deserializeJSONResponse(
                httpRes?.data,
          ...
          case httpRes?.status == 403:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.getUserBusyTimes403ApplicationJSONObject = utils.deserializeJSONResponse(
                httpRes?.data,
